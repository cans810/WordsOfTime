...
public class GridManager : MonoBehaviour
{
    ...
    public void SetupNewPuzzle(string word)
    {
        ...
        // If this word was previously solved, restore the solved tiles
        if (isWordSolved && solvedWordTiles.ContainsKey(word))
        {
            foreach (var tile in solvedWordTiles[word])
            {
    ...
    private void SubmitWord()
    {
        ...
        if (currentWord.Equals(targetWord, StringComparison.OrdinalIgnoreCase))
        {
            ...
            // Store the solved tiles for this word
            solvedWordTiles[targetWord] = new List<LetterTile>(selectedTiles);
