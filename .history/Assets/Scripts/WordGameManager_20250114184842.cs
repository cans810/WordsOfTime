...
public class WordGameManager : MonoBehaviour
{
    ...
    public void StartNewGameInEra()
    {
        ...
        if (currentEraWords == null || currentEraWords.Count == 0)
        {
            ...
            return; // Or handle the error appropriately (e.g., go back to menu)
        }
    ...
    public void LoadWord(int index)
    {
        ...
        if (sentence == null)  // Check if the sentence is null
        {
        ...
        GridManager.Instance.ResetGridForNewWord();  // Make sure GridManager exists
    ...
    public void NextWord()
    {
        ...
        else
        {
            ...
            // Handle end of era - load next era, go to main menu, etc.  
