...
public class WordGameManager : MonoBehaviour
{
    ...
    // ... (Rest of StartNewGameInEra - same as before)
    ...
    public void NextWord()
    {
        ...
        else // Era finished
        {
            ...
            // Check GameManager instance *before* calling MoveToNextEra
            if (GameManager.Instance == null) 
            {
                Debug.LogError("GameManager.Instance is null!");
                return; // Or handle appropriately (e.g., load main menu)
            }


            GameManager.Instance.MoveToNextEra();

            if (GameManager.Instance.CurrentEra != null) // There's a next era
            {
                Debug.Log("Starting new game in the next era..."); // Debug log

                try 
                {
                    StartNewGameInEra();  // Wrap in try-catch
