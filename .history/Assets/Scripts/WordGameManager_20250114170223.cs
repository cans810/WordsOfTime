...
public class WordGameManager : MonoBehaviour
{
    ...
    private void UpdateProgressBar()
    {
        ...
        {
            // Handle error - progress bar not initialized or no words in era
            Debug.LogError("Progress bar not initialized or no words found for this era."); // Log the error
        ...
        {
            Image image = progressImages[i].GetComponent<Image>(); // Assuming you're using Image components
    ...
    public void HandleCorrectWord()
    {
        ...
        UpdateProgressBar(); // Update progress after correct word
