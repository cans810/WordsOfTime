...
public class WordGameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (gameSceneCanvas != null)
        {
            ...
            {
                Transform sentence = gameSceneCanvas.transform.Find("Sentence");
            ...
            {
                // Get the SpriteRenderer or Image component (depending on your setup)
                progressBarContainer = backgroundImageTransform.GetComponent<SpriteRenderer>(); // For SpriteRenderer
            }
        }
