    ...
    private void UpdateProgressBar()
    {
        ...
        for (int i = 0; i < progressImages.Count; i++)
        {
            ...
            else if (i == currentWordIndex)
            {
                ...
                rectTransform.localScale = new Vector3(0.34f, 0.34f, 0.34f); // Adjust 1.2f as needed
                image.color = Color.white;    // Current word
            }
            else if (i == currentWordIndex && solvedWordsInCurrentEra.Contains(i))
            {
                // Slightly increase size for current word
                rectTransform.localScale = new Vector3(0.36f, 0.36f, 0.34f); // Adjust 1.2f as needed
