...
public class WordGameManager : MonoBehaviour
{
    ...
    public void HandleCorrectWord()
    {
        ...
        if (solvedWordsInCurrentEra.Count == currentEraWords.Count)
        {
            ...
            StartNewGameInEra(); // Start a new game in the next era
        }
        else
        {
            // If not all words are solved, load the next word in the current era
            NextWord(); 
        }
    }
    ...
    {
        currentWord = "";
        UpdateCurrentWord("");  // Update the display to show blanks
    }
