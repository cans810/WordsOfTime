...
public class GridManager : MonoBehaviour
{
    ...
    [SerializeField] private LineRenderer lineRendererPrefab; // Assign a prefab with LineRenderer
    ...
    private void Awake()
    {
        ...
        CreateLineRenderer(); // Create LineRenderer instance in Awake
    }
    ...
    private void CreateLineRenderer()
    {
         ...
         currentLineRenderer.transform.SetParent(gridContainer);
         currentLineRenderer.transform.localPosition = Vector3.zero; // Align with the grid
         currentLineRenderer.positionCount = 0; // Start with no points
    }
    ...
    private void UpdateLineRenderer()
    {
        ...
        {
            Transform tileTransform = selectedTiles[i].transform;
            currentLineRenderer.SetPosition(i, tileTransform.position);
        }
    }
