...
public class GridManager : MonoBehaviour
{
    ...
    {
        // Your existing PlaceWordAdjacent logic adapted to use gridToFill and letters
        // Example (adapt as needed):
        Vector2Int currentPos = /* ... your start position logic ... */;
        for (int i = 0; i < letters.Count; i++)
        {
            gridToFill[currentPos.x, currentPos.y] = letters[i];
            // ... (Your logic to update currentPos for the next letter)
        }
    }
