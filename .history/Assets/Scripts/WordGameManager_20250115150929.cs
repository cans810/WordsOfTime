...
public class WordGameManager : MonoBehaviour
{
    ...
    private void UpdateProgressBar()
    {
        ...
        Debug.Log($"Updating progress bar. Solved words: {solvedWordCountInCurrentEra}, Total images: {progressImages.Count}");
        ...
        for (int i = 0; i < progressImages.Count; i++)
        {
            ...
            {
                image.color = Color.white;  // Future words
            }
        }
    }
    ...
    public void NextWord()
{
    ...
    if (nextIndex >= currentEraWords.Count)
    {
        ...
        return;  // Stop here instead of moving to next era
    }

    // Continue with normal word progression
    ...
    public void PreviousWord()
    {
        ...
        if (prevIndex >= 0)
        {
            try
            {
                ...
                solvedWordCountInCurrentEra = Math.Max(0, solvedWordCountInCurrentEra - 1);
