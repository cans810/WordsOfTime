...
public class WordGameManager : MonoBehaviour
{
    ...
    private void InitializeUI()
    {
        ...
        BackgroundImage.sprite = GameManager.Instance.getEraImage(GameManager.Instance.ERA);
    }
    ...
    public void HandleCorrectWord()
    {
        ...
        GridManager.Instance.SelectTargetWord(); // Get new word
        UpdateSentenceDisplay(); // Update sentence display
    }
