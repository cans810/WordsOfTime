...
public class WordGameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (gameSceneCanvas != null)
        {
            ...
            // Find the BackgroundImage child object
            Transform messageTextTransform = gameSceneCanvas.transform.Find("MessageText");

            if (backgroundImageTransform != null)
            {
                // Get the SpriteRenderer or Image component (depending on your setup)
                messageTextTransform = backgroundImageTransform.GetComponent<TextMeshProUGUI>(); // For SpriteRenderer
            }
        }
