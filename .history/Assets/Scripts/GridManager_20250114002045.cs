...
public class GridManager : MonoBehaviour
{
    ...
    private LineRenderer GetLineRenderer()
    {
        ...
        line.positionCount = 0; // Reset the line
    ...
    {
        ClearLines(); // Clear any previous lines
        ...
        // Place remaining letters and draw lines
        for (int i = 1; i < targetWord.Length; i++)
        {
            ...
            // Draw line from previousPos to currentPos
            LineRenderer line = GetLineRenderer();
            line.positionCount = 2;
            line.SetPosition(0, GridToWorldPosition(previousPos));
            line.SetPosition(1, GridToWorldPosition(currentPos));
...
{
    // Adjust this based on your grid and cell size
    float cellSize = 1.0f; // Replace with your actual cell size
