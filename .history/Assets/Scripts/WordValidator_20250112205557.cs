...
public static class WordValidator
{
    ...
    {
        if (wordSetsWithSentences != null && wordSets.ContainsKey(era))
        {
            // Convert the list of words from the WordSet object into a List and return it
            return new List<string>(wordSets[era].words);
        }
