...
public static class WordValidator
{
    ...
    {
        // OPTIONAL: You may skip reading JSON a second time
        // and instead reference GameManager.Instance.wordSetsWithSentences
        LoadWordSets();
    }
    ...
    {
        // If you want to rely on the data from GameManager:
        // var localDict = GameManager.Instance.wordSetsWithSentences;
        ...
        {
            Debug.LogError($"Era '{era}' not found.");
            return "Sentence not found.";
        }
    ...
    {
        if (wordSetsWithSentences == null) return false;
