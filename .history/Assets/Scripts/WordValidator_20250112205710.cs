...
public static class WordValidator
{
    ...
    {
        if (wordSetsWithSentences != null && wordSetsWithSentences.ContainsKey(era) && (IEnumerable<string>)wordSetsWithSentences[era].Contains(word.ToUpper()))
        {
            return true;
        }
        return false;
    ...
    public static List<string> GetWordsForEra(string era)
    {
        if (wordSetsWithSentences != null && wordSetsWithSentences.ContainsKey(era))
        {
            ...
            return new List<string>((IEnumerable<string>)wordSetsWithSentences[era]);
        }
