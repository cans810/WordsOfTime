...
public class WordGameManager : MonoBehaviour
{
    ...
    private void UpdateHintButton()
    {
        ...
        if (hintButtonText != null)
        {
            hintButtonText.text = isSolved ? "Çözüldü" : "İpucu";
        }
    }
    ...
    {
        // Get the base word (English version) first
        string baseWord = GameManager.Instance.GetBaseWord(targetWord);
        
        // Get the fact for the base word in the current language
        string fact = WordValidator.GetFactForWord(baseWord, GameManager.Instance.CurrentEra, GameManager.Instance.CurrentLanguage);
