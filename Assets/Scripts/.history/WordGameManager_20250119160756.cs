...
public class WordGameManager : MonoBehaviour
{
    ...
    public void StartNewGameInEra()
    {
        ...
        solvedWordsInCurrentEra.Clear(); // Clear existing solved words
        var solvedWords = GameManager.Instance.GetSolvedWordsForEra(GameManager.Instance.CurrentEra);
    ...
    private void MarkSolvedWords()
    {
        ...
        foreach (var word in solvedWords)
        {
            if (GameManager.Instance.InitialGrids.ContainsKey(word))
            {
                ...
                var tiles = positions.Select(pos => GridManager.Instance.GetTileAtGridPosition(pos)).ToList();
