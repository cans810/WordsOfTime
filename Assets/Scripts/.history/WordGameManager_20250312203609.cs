...
public class WordGameManager : MonoBehaviour
{
    ...
    // Show an interstitial ad after every 5 words guessed, complying with Google's ad frequency guidelines
    ...
    private void ShowAd()
    {
        ...
        // Find the InterstitialAdExample component
        InterstitialAdExample interstitialAd = FindObjectOfType<InterstitialAdExample>();
        
        // Check if AdManager exists to handle child-directed content
        ...
        if (interstitialAd != null)
        {
            ...
            if (Advertisement.isInitialized)
            {
                ...
                // If we have an AdManager, notify it that an ad was shown
                if (adManager != null)
                {
            ...
            {
                // Ad not ready, load it for next time
                interstitialAd.LoadAd();
                Debug.Log("Ad not ready, loading for next time");
            }
        }
        else
        {
            Debug.LogWarning("InterstitialAdExample component not found");
        }
        
        // Reset the counter regardless of whether the ad was shown
        wordsGuessedCount = 0;
    }
    ...
    public void VibrateDevice(){
        // Use the CandyCoded.HapticFeedback plugin
