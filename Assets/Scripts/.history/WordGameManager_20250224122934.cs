...
public class WordGameManager : MonoBehaviour
{
    ...
    public void SetupGame(string word, string sentence, string difficulty)
    {
        targetWord = word;
        ...
        Debug.Log($"New word to guess: {targetWord} (Difficulty: {difficulty})");
    ...
    public void LoadWord(int wordIndex)
    {
        ...
        {
            // Get the word data from GameManager
            var wordData = GameManager.Instance.GetWordData(currentEraWords[wordIndex]);
            
            // Setup the game with word, sentence, and difficulty
            SetupGame(wordData.word, wordData.sentence, wordData.difficulty);
