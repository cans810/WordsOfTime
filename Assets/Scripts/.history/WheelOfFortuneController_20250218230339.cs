...
public class WheelOfFortuneController : MonoBehaviour
{
    ...
    {
        // Only show the panel for "Random Era Unlocked" or "Try Again Later"
        if (prize.name == "Random Era Unlocked" || prize.name == "Try Again Later")
        {
    ...
    {
        // Instantiate all coins at the trianglePicker position
