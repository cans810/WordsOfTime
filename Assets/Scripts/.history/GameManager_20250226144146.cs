...
public class GameManager : MonoBehaviour
{
    ...
    public string GetTranslation(string baseWord, string language)
    {
            ...
            wordTranslations[baseWord].ContainsKey(language))
        {
            ...
            Debug.Log($"Found translation: {translation}");
            return translation;
        }
            ...
            eraWordsPerLanguage.ContainsKey(language))
        {
            foreach (var era in eraList)
            {
                ...
                {
                    var englishWords = eraWordsPerLanguage["en"][era];
                    var targetLanguageWords = eraWordsPerLanguage[language][era];
                    ...
                    if (index >= 0 && index < targetLanguageWords.Count)
                    {
                        ...
                        Debug.Log($"Found translation from era words: {translation}");
