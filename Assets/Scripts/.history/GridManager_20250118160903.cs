...
public class GridManager : MonoBehaviour
{
    ...
    private List<Button> buttons; // Your list of grid buttons
    private List<Button> currentSelectedButtons; // Your currently selected buttons
    ...
    public void HighlightFirstLetter(char letter)
    {
        ...
        for (int i = 0; i < currentSelectedButtons.Count; i++)
        {
            Button button = currentSelectedButtons[i];
