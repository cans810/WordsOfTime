...
public class WordGameManager : MonoBehaviour
{
    ...
    public void HandleCorrectWord(List<LetterTile> guessedTiles)
    {
        ...
        StartCoroutine(PlaySuccessSequence(guessedTiles));
    }

    private IEnumerator PlaySuccessSequence(List<LetterTile> guessedTiles)
    {
    ...
    public void CheckWord(string word, List<LetterTile> selectedTiles)
    {
        ...
        if (word == targetWord)
        {
            ...
            string fact = WordValidator.GetFactForWord(word, GameManager.Instance.CurrentEra);
    ...
    private void ShowDidYouKnow(string fact)
    {
        if (!string.IsNullOrEmpty(fact))
        {
