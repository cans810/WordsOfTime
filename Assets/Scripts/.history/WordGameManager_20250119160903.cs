...
public class WordGameManager : MonoBehaviour
{
    ...
    public void StartNewGameInEra()
    {
        ...
        solvedWordsInCurrentEra.Clear();  // Clear existing entries
        foreach (string word in GameManager.Instance.GetSolvedWordsForEra(GameManager.Instance.CurrentEra))
        {
    ...
    private void MarkSolvedWords()
    {
        ...
        foreach (string word in GameManager.Instance.GetSolvedWordsForEra(GameManager.Instance.CurrentEra))
        {
            if (GameManager.Instance.InitialGrids.ContainsKey(word))
            {
                ...
                var tiles = positions.Select(pos => GridManager.Instance.GetLetterTile(pos)).ToList();
