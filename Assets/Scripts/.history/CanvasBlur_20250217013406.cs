...
public class CanvasBlur : MonoBehaviour
{
    ...
    public void Initialize(Canvas canvas)
    {
        if (canvas == null)
        {
            Debug.LogError("Canvas parameter is null!");
            return;
        }
        ...
        if (blurObject == null)
        {
            Debug.LogError("Failed to create blur object!");
            return;
        }
        ...
        {
            Debug.LogError("Transform or parent is null!");
            return;
        }
        ...
        {
            Debug.LogError("Could not find WheelOfFortuneController!");
            return;
        }
        
        if (wheelController.canvas == null)
        {
            Debug.LogError("WheelOfFortuneController canvas is null!");
            return;
        }
