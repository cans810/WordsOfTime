...
public class WordGameManager : MonoBehaviour
{
    ...
    private void ShowAd()
    {
        if (GameManager.Instance.NoAdsBought || justShowedAd)
        {
            Debug.Log("No Ads purchased or ad just shown - skipping ad");
            return;
        }
    ...
    private void ShowDidYouKnow()
    {
        ...
        {
            Debug.LogError("Did You Know panel is null!");
            return;
        }
        ...
        {
            Debug.LogWarning($"No fact found for word: {targetWord}");
        }
    }
