...
public class WordGameManager : MonoBehaviour
{
    ...
    public bool IsWordSolved(string word)
    {
        ...
        {
            return GameManager.Instance.IsWordSolved(currentBaseWord);
        }
    ...
    public void NextWord()
    {
        ...
        // Check if the current word is already solved - use currentBaseWord instead of calling GetBaseWord again
        if (GameManager.Instance.IsWordSolved(currentBaseWord))
        {
            Debug.Log($"Word {currentBaseWord} is solved, highlighting in grid");
            HighlightWordInGrid(targetWord);
        }
        else
        {
