...
public class WheelOfFortuneController : MonoBehaviour
{
    ...
    [SerializeField] private float coinSpeedMin = 100f; // Time in seconds to reach the target
    [SerializeField] private float coinSpeedMax = 200f; // Time in seconds to reach the target
