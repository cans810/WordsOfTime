...
public class SaveManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        try
        {
            ...
            Debug.Log($"Saving game with NoAdsBought state: {Data.noAdsBought}");
        ...
        try
        {
            if (File.Exists(SavePath))
            {
                ...
                if (GameManager.Instance != null)
                {
                    ...
                    // Load no ads state with explicit logging for debugging
                    Debug.Log($"Loading NoAdsBought state: {Data.noAdsBought}");
                    GameManager.Instance.SetNoAdsBought(Data.noAdsBought);
                    
                    // Ensure ads are hidden immediately if NoAdsBought is true
                    if (Data.noAdsBought && AdManager.Instance != null)
                    {
            ...
            else
            {
                ...
                Debug.Log("New save created with NoAdsBought set to FALSE");
