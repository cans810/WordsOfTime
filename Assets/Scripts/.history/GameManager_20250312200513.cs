...
public class GameManager : MonoBehaviour
{
    ...
    {
        Debug.Log($"[Android Debug] Marking word as solved: {word}");
        
        // Store the base word as solved for the current era
        StoreSolvedBaseWord(CurrentEra, word);
        
        // Add to guessed words
        AddGuessedWord(word);
        
        // Trigger word guessed event
        TriggerWordGuessed(word);
