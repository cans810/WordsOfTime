...
public class WordGameManager : MonoBehaviour
{
    ...
    private void HandleLanguageChanged()
    {
        ...
        if (GameManager.Instance.CurrentLanguage == "tr")
        {
            ...
            {
                WordValidator.Instance.VerifyTurkishFacts();
            }
            else
            {
                Debug.LogWarning("[Android Debug] WordValidator.Instance is null, can't verify Turkish facts");
            }
        }
        
        // If the current word is already solved, refresh its fact
        if (GameManager.Instance.IsWordSolved(currentBaseWord))
        {
