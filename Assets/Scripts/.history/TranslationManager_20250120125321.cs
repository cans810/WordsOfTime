...
public class TranslationManager : MonoBehaviour
{
    ...
    private static void Initialize()
    {
        if (Instance == null)
        {
            // Create a new GameObject for TranslationManager
            GameObject go = new GameObject("TranslationManager");
            Instance = go.AddComponent<TranslationManager>();
            DontDestroyOnLoad(go);
            Debug.Log("TranslationManager initialized");
        }
    }
    ...
    private void Awake()
    {
        if (Instance == null)
        {
            ...
            Debug.Log("TranslationManager instance set");
        }
        else if (Instance != this)
        {
            Destroy(gameObject);
            Debug.Log("Duplicate TranslationManager destroyed");
        }
    }
