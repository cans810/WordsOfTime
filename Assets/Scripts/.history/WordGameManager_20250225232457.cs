...
public class WordGameManager : MonoBehaviour
{
    ...
    private void HighlightWordInGrid(string word)
    {
        ...
        Debug.Log($"Highlighting word in grid: Original={word}, Base={currentBaseWord}, Translated={translatedWord}");
        ...
        if (!wordFound)
        {
            Debug.LogError($"Failed to find word: {translatedWord} in grid!");
        }
    }
