...
public class WordGameManager : MonoBehaviour
{
    ...
    private void PreloadFactForWord(string word)
    {
        ...
        if (string.IsNullOrEmpty(fact) || fact == "LOADING")
        {
            ...
            // Check the JSON file for the current language
        ...
        {
            Debug.LogWarning($"[WordGameManager] Failed to preload fact for '{word}' in {language}");
        }
    }
    ...
    public void ShowDidYouKnowInstantly()
    {
        ...
        try
        {
            ...
            Debug.Log($"[DidYouKnow Debug] Current language: {language}, era: {era}");
