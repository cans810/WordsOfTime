...
public class WordGameManager : MonoBehaviour
{
    ...
    private IEnumerator AnimatePointsIncrease(int pointsToAdd, List<LetterTile> guessedTiles)
    {
        ...
        while (elapsedTime < animationDuration)
        {
            ...
            int currentPoints = Mathf.RoundToInt(Mathf.Lerp(currentPoints, currentPoints + pointsToAdd, t));
        ...
        if (pointText != null)
        {
            pointText.text = (currentPoints + pointsToAdd).ToString();
            pointText.transform.localScale = originalScale;
    ...
    public void HandleCorrectWord(List<LetterTile> guessedTiles)
    {
        ...
        // Start both animations simultaneously
        StartCoroutine(SpawnCoins(8, GameManager.POINTS_PER_WORD, guessedTiles));
        StartCoroutine(AnimatePointsChange(GameManager.POINTS_PER_WORD, guessedTiles));
