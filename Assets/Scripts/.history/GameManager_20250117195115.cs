...
public class GameManager : MonoBehaviour
{
    ...
    public int CurrentPoints
    {
        get 
        { 
            Debug.Log($"[GameManager] Getting current points: {currentPoints}");
            return currentPoints; 
        }
        private set 
        { 
            Debug.Log($"[GameManager] Setting points from {currentPoints} to {value}");
            currentPoints = value;
    ...
    public void AddPoints(int points)
    {
        ...
        Debug.Log($"[GameManager] Points added: {points}, New total: {currentPoints}");
        OnPointsChanged?.Invoke();
    }
