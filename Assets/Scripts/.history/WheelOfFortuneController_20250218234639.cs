...
public class WheelOfFortuneController : MonoBehaviour
{
    ...
    [SerializeField] private float coinSpeedMin = 0.5f; // Time in seconds to reach the target
    [SerializeField] private float coinSpeedMax = 1.5f; // Time in seconds to reach the target
