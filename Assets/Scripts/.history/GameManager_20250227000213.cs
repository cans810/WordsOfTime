...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (_instance == null)
        {
            ...
            // Note: Removed Init() call as it doesn't exist
            SaveManager.Instance.LoadGame();
            
            // Force initialization of word facts
            Debug.Log("[GameManager] Awake - Explicitly calling TryStartAndroidLoading to ensure facts are loaded");
            WordValidator.TryStartAndroidLoading();
        }
        else
        {
            Destroy(gameObject);
