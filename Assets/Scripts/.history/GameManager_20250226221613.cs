...
public class GameManager : MonoBehaviour
{
    ...
    public bool NoAdsBought
    {
        get
        {
            // Always check the saved value to ensure we have the latest state
            if (SaveManager.Instance != null)
            {
                noAdsBought = SaveManager.Instance.Data.noAdsBought;
    ...
    public bool NoAds => noAdsBought || noAds; // Return true if either flag is set
    ...
    public void SetNoAdsBought(bool value)
    {
        ...
        // Hide any active ads if they're showing
        if (value && AdManager.Instance != null)
        {
