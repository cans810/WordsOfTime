            ...
            foreach (var word in eraWords[era])
            {
                if (!initialGrids.ContainsKey(word))
                {
                    ...
                    if (word.Length <= GRID_SIZE * GRID_SIZE)
                    {
                        ...
                        int maxAttempts = 200; // Increased attempts for more randomness
                        bool placed = false;
                        ...
                        while (!placed && maxAttempts > 0)
                        {
                            try
                            {
                                ...
                                for (int i = 1; i < word.Length; i++)
                                {
                                    ...
                                    // Randomize direction order for more varied patterns
                                ...
                                if (validPath)
                                {
                                    ...
                                    Debug.Log($"Placed word {word} in snake pattern");
                                }
                            }
                            catch (System.Exception e)
                            {
