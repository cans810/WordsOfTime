...
public class WordGameManager : MonoBehaviour
{
    ...
    private void HandleLanguageChanged(object sender, string newLanguage)
    {
    ...
    private void ClearGrid()
    {
        ...
        {
            // Since ClearGrid() is not accessible, we'll use a different approach
            // This might involve sending a message to the GridManager or using a public method
            ...
            // or add a public method to GridManager
        }
        else
        {
    ...
    private void UpdateHintCostDisplay()
    {
        ...
        if (hintPointAmountText != null)
        {
            hintPointAmountText.text = GameManager.HINT_COST.ToString();
        }
    }
    ...
    private void ClearInputFields()
    {
        ...
        if (GridManager.Instance != null)
        {
            // Since ClearSelection() is not accessible, we'll use a different approach
            // This might involve sending a message to the GridManager or using a public method
            
            // Option 1: Try to find a public method that does something similar
            GridManager.Instance.ResetSelection();
