    ...
    public void SelectEra(string era)
    {
        ...
        if (GameManager.Instance != null)
        {
            ...
            if (isUnlocked)
            {
                ...
                // Check if there's an active didYouKnowPanel and hide it
                GameObject didYouKnowPanel = GameObject.Find("DidYouKnowPanel");
                if (didYouKnowPanel != null && didYouKnowPanel.activeSelf)
                {
                    Debug.Log("Hiding DidYouKnowPanel before era change");
    ...
    private IEnumerator RefreshGameWithNewEra()
    {
        ...
        if (wordGameManager != null)
        {
            try
            {
                ...
                // Make sure any didYouKnowPanel is properly initialized after era change
                wordGameManager.InitializeDidYouKnowPanel();
