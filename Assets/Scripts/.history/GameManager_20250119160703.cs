...
public class GameManager : MonoBehaviour
{
    ...
    private Dictionary<string, HashSet<string>> solvedWordsPerEra = new Dictionary<string, HashSet<string>>();
    ...
    public void StoreSolvedWord(string era, string word)
    {
        if (!solvedWordsPerEra.ContainsKey(era))
        {
            solvedWordsPerEra[era] = new HashSet<string>();
        }
        solvedWordsPerEra[era].Add(word);
        Debug.Log($"Stored solved word: {word} for era {era}");
    }

    public bool IsWordSolved(string era, string word)
    {
        return solvedWordsPerEra.ContainsKey(era) && 
               solvedWordsPerEra[era].Contains(word);
    }
    ...
    public HashSet<string> GetSolvedWordsForEra(string era)
    {
        if (solvedWordsPerEra.ContainsKey(era))
        {
            return new HashSet<string>(solvedWordsPerEra[era]);
        }
    ...
    public void SwitchEra(string newEra)
    {
        ...
        {
            solvedWordsPerEra[newEra] = new HashSet<string>();
        }
    }
