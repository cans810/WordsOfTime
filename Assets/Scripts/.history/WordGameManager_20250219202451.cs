...
public class WordGameManager : MonoBehaviour
{
    ...
    private IEnumerator AnimatePointsIncrease(int pointsToAdd)
    {
        ...
        // Actually add/subtract the points to GameManager after animation completes
    ...
    private IEnumerator SpawnCoins(int coinCount, List<LetterTile> guessedTiles)
    {
        ...
        for (int i = 0; i < coinCount; i++)
        {
            ...
            coin.tag = "Coin";
            StartCoroutine(MoveCoinToPanel(coin, null)); // Remove the points animation callback
        }
    }
