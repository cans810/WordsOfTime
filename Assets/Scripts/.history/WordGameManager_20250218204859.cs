...
public class WordGameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Load solved words from PlayerPrefs
        LoadSolvedWords();
    }
    ...
    {
        // Convert the set of solved words to a comma-separated string
        string solvedWordsString = string.Join(",", solvedWords);
        PlayerPrefs.SetString("SolvedWords", solvedWordsString);
        PlayerPrefs.Save();
    }

    private void LoadSolvedWords()
    {
        // Load the solved words from PlayerPrefs
        string solvedWordsString = PlayerPrefs.GetString("SolvedWords", "");
        if (!string.IsNullOrEmpty(solvedWordsString))
        {
            solvedWords = new HashSet<string>(solvedWordsString.Split(','));
        }
