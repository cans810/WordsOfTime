...
public class WordGameManager : MonoBehaviour
{
    ...
    private IEnumerator AnimatePointsIncrease()
    {
        ...
        while (elapsed < duration)
        {
            ...
            int displayPoints = (int)Mathf.Lerp(currentPoints, targetPoints, t);
