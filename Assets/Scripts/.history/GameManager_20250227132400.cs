...
public class GameManager : MonoBehaviour
{
    ...
    public List<string> GetGuessedWords()
    {
        ...
        foreach (var era in solvedWordsPerEra)
        {
    ...
    public void SetGuessedWords(List<string> words)
    {
        ...
        foreach (string word in words)
        {
            ...
            solvedWordsPerEra[era].Add(word);
        ...
        foreach (var era in solvedWordsPerEra.Keys)
        {
            Debug.Log($"Era '{era}' has {solvedWordsPerEra[era].Count} solved words: {string.Join(", ", solvedWordsPerEra[era])}");
        }
    }
    ...
    public bool IsWordGuessed(string word)
    {
        ...
        bool isSolved = solvedWordsPerEra.ContainsKey(CurrentEra) && 
                       solvedWordsPerEra[CurrentEra].Contains(baseWord);
