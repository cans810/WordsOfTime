...
public class WordGameManager : MonoBehaviour
{
    ...
    public List<WordEntry> currentEraWords;
    ...
    public void StartNewGameInEra()
    {
        ...
        if (GameManager.Instance != null)
        {
            // Example: Populate currentEraWords with WordEntry objects from the WordSet
            WordSet currentWordSet = GetCurrentWordSet(); // Replace with your logic to get the current WordSet
            currentEraWords = new List<WordEntry>(currentWordSet.words);
    ...
    private void InitializeUI()
    {
        ...
        // Find the difficultyText field if not assigned
    ...
    {
        // Fetch the word data
        WordEntry wordEntry = currentEraWords[wordIndex];
        string word = wordEntry.word;
        string difficulty = wordEntry.difficulty;

        // Update the difficultyText field
        if (difficultyText != null)
        {
            difficultyText.text = difficulty.ToUpper(); // Display the difficulty in uppercase
        }

        // ... rest of the existing code to load the word ...
    }
