...
public class WordGameManager : MonoBehaviour
{
    ...
    public void StartNewGameInEra()
    {
        ...
        var solvedWordsStrings = GameManager.Instance.GetSolvedWordsForEra(GameManager.Instance.CurrentEra).ToList();
    ...
    private void MarkSolvedWords()
    {
        ...
        foreach (string word in solvedWordsStrings)
        {
            if (GameManager.Instance.InitialGrids.ContainsKey(word))
            {
                ...
                var tiles = positions.Select(pos => GridManager.Instance.GetTile(pos)).ToList();
