...
public class GameManager : MonoBehaviour
{
    ...
    public void LoadGame()
    {
        ...
        if (SaveManager.Instance != null)
        {
            // Ensure SaveData is loaded but don't trigger the full LoadGame process
            // which would cause circular references
            if (!File.Exists(SaveManager.Instance.SavePath))
            {
            ...
            // Access the SaveData directly instead of calling LoadGame()
