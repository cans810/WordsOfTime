...
public class WordGameManager : MonoBehaviour
{
    ...
    public void CheckWord(string word, List<LetterTile> selectedTiles)
    {
        ...
        if (word == targetWord)
        {
            ...
            // Notify AdManager that a word was guessed
            if (AdManager.Instance != null)
            {
                Debug.Log("Notifying AdManager of word guess");
                AdManager.Instance.OnWordGuessed();
            }
            
            // Check if it's time to show an ad (keep existing code for compatibility)
