...
public class WordGameManager : MonoBehaviour
{
    ...
    public void LoadWord(int index)
    {
        ...
        {
            // Option 1: Scrolls/Manuscripts theme
            difficultyText.text = difficulty switch
            {
                "easy" => "📜",      // Single scroll
                "normal" => "📜📜",   // Double scroll
                "hard" => "📜📜📜",   // Triple scroll
                _ => "📜"
            };

            // Option 2: Historical symbols
            difficultyText.text = difficulty switch
            {
                "easy" => "⚔️",       // Single sword
                "normal" => "⚔️⚔️",    // Double swords
                "hard" => "⚔️⚔️⚔️",    // Triple swords
                _ => "⚔️"
            };

            // Option 3: Mixed historical symbols
            difficultyText.text = difficulty switch
            {
                "easy" => "⚔️",       // Sword
                "normal" => "👑",     // Crown
            ...
            // Option 4: Era-specific symbols (more complex but thematic)
            string symbol = GameManager.Instance.CurrentEra switch
            {
                "Ancient Egypt" => "🔮",      // Crystal ball or pyramid
                "Medieval Europe" => "⚔️",     // Sword
                "Renaissance" => "🎨",         // Art palette
                "Industrial Revolution" => "⚙️", // Gear
                "Viking Age" => "⚓",          // Anchor
                "Ottoman Empire" => "☪️",      // Crescent
                "Feudal Japan" => "⛩️",        // Temple
                _ => "📜"
            };
            
            // Repeat the era symbol based on difficulty
            difficultyText.text = difficulty switch
            {
                "easy" => symbol,
                "normal" => symbol + symbol,
                "hard" => symbol + symbol + symbol,
                _ => symbol
            };
        }
    }
