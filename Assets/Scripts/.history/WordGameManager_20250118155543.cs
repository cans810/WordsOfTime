...
public class WordGameManager : MonoBehaviour
{
    ...
    private const float POINT_ANIMATION_DURATION = 1.3f; // Even faster overall animation
    private const float BUMP_SCALE = 1.30f; // Slightly smaller bump for smoother feel
    private const float BUMP_DURATION = 0.10f; // Faster bumps
    ...
    private IEnumerator AnimatePointsChange(int startPoints, int endPoints)
    {
        ...
        while (elapsedTime < animationDuration)
        {
            ...
            // Steeper acceleration curve for faster animation
