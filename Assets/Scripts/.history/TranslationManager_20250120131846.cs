    ...
    {
        {
            "en", new Dictionary<string, string>
            {
                ...
                {"medival_europe", "Medieval Europe"},
                {"renaissance", "Renaissance"},
                {"industrial_revolution", "Industrial Revolution"},
                {"ancient_greece", "Ancient Greece"},
                {"points", "points"},
                {"ancient_egypt_points", "Ancient Egypt Points: {0}"},
                {"medieval_europe_points", "Medieval Europe Points: {0}"},
                {"renaissance_points", "Renaissance Points: {0}"},
                {"industrial_revolution_points", "Industrial Revolution Points: {0}"},
                {"ancient_greece_points", "Ancient Greece Points: {0}"},
            }
        },
        {
            "tr", new Dictionary<string, string>
            {
                ...
                {"medival_europe", "Orta Cag Avrupa"},
                {"renaissance", "Rönesans"},
                {"industrial_revolution", "Sanayi Devrimi"},
                {"ancient_greece", "Antik Yunan"},
                {"points", "puan"},
                {"ancient_egypt_points", "Antik Mısır Puanı: {0}"},
                {"medieval_europe_points", "Orta Çağ Avrupa Puanı: {0}"},
                {"renaissance_points", "Rönesans Puanı: {0}"},
                {"industrial_revolution_points", "Sanayi Devrimi Puanı: {0}"},
                {"ancient_greece_points", "Antik Yunan Puanı: {0}"},
            }
        }
    };
