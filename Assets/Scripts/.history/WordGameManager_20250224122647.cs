...
public class WordGameManager : MonoBehaviour
{
    ...
    public void StartNewGameInEra()
    {
        ...
        if (GameManager.Instance != null)
        {
            ...
            currentEraWords = new List<WordEntry>(GameManager.Instance.eraWordsPerLanguage[GameManager.Instance.CurrentLanguage][GameManager.Instance.CurrentEra]);
    ...
    public void LoadWord(int index)
    {
        ...
        targetWord = currentEraWords[currentWordIndex].word;
        ...
        // Fetch the difficulty from the current word data
        string difficulty = currentEraWords[index].difficulty;
