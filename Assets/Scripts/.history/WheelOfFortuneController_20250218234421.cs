...
public class WheelOfFortuneController : MonoBehaviour
{
    ...
    [SerializeField] private float coinSpeedMin = 50f; // Reduced further for slower movement
    [SerializeField] private float coinSpeedMax = 150f; // Reduced further for slower movement
