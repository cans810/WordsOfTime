...
public class WordGameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject progressImagePrefab;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError($"WordGameManager initialization failed: {e.Message}\n{e.StackTrace}");
        }
    }
    ...
    private void InitializeGame()
    {
        ...
        currentEraWords = new List<string>();
        solvedWordsInCurrentEra = new HashSet<int>();
        progressImages = new List<GameObject>();
    }
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError($"WordGameManager Start failed: {e.Message}\n{e.StackTrace}");
        }
    }
