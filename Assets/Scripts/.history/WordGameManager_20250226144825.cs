...
public class WordGameManager : MonoBehaviour
{
    ...
    private void HighlightWordInGrid(string word)
    {
        ...
        // Search for the word in the grid dynamically
    ...
    public void CheckWord(string word, List<LetterTile> selectedTiles)
    {
        ...
        if (word == targetWord)
        {
            ...
            // Temporarily set the current era to ensure translations are from the correct era
            ...
            foreach (string language in new[] { "en", "tr" })
            {
                ...
                Debug.Log($"Storing positions for translated word ({language}): {translatedWord} in era: {currentEra}");
                ...
                {
                    Debug.LogWarning($"Failed to get translation for {currentBaseWord} in {language}");
                }
            }
