...
public class SaveManager : MonoBehaviour
{
    ...
    private const int COOLDOWN_HOURS = 2; // Assuming a default value, actual implementation needed
    ...
    public void Initialize()
    {
        ...
        {
            Data.lastDailySpinTimestamp = DateTimeOffset.UtcNow.ToUnixTimeSeconds() - (COOLDOWN_HOURS * 3600);
        }
    }
}