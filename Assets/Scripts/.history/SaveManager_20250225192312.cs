            ...
            if (File.Exists(JsonSavePath))
            {
                ...
                else
                {
                    ...
                    if (Data.adState != null)
                    {
                        ...
                        Debug.Log($"Processed AdState: canWatch={Data.adState.canWatch}, nextAvailableTime={Data.adState.nextAvailableTime}");
                    }
                    else
                    {
                        Debug.LogWarning("AdState is null after deserialization");
                    }
