...
public class SaveManager : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log($"Starting SaveManager");
    ...
    public void SaveGame()
    {
        ...
        try
        {
            ...
            // Prepare dictionary data for serialization
            ...
            // Save using SimpleSaveSystem
            SimpleSaveSystem.Save(Data);
            
            // Save text file for debugging
            SaveGameAsText();
    ...
    public void LoadGame()
    {
        ...
        catch (Exception e)
        {
            ...
            // If loading fails, create a new save
