...
public class GridManager : MonoBehaviour
{
    ...
    {
        Debug.Log($"Trying to highlight letter: {letter}"); // Debug log
        ...
        foreach (Button button in buttons)
        {
            if (button != null)
            {
                ...
                {
                    Debug.Log($"Found matching letter in button: {buttonText.text}"); // Debug log
    ...
    // Add this method to track selected buttons
    ...
    // Add this method to clear selected buttons
